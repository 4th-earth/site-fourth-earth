...
?>
    <article id="main-content">
        ...
        <p>From roughly <button class="popover" popovertarget="third-earth-time">year 4,700 to 5,300</button>.</p>        
        ...
        <p>From roughly <button class="popover" popovertarget="second-earth-time">year 4,400 to 4,700</button>.</p>

        <h2 id="first-earth">First Earth</h2>
        <p>From roughly <button class="popover" popovertarget="first-earth-time">year zero to 4,400</button>.</p>

    </article>
    <!-- Defintions -->
    <div popover id="first-earth-time">
        <p>Roughly 2,100 <abbr title="Before Common Era">BCE</abbr> to 2,300 <abbr title="Common Era">CE</abbr> in the Gegorian Calendar.</p>
        <button popovertargetaction="hide" popovertarget="first-earth-time">close</button>
    </div>
    <div popover id="second-earth-time">
        <p>Roughly 2,300 <abbr title="Common Era">CE</abbr> to 2,600 <abbr title="Common Era">CE</abbr> in the Gegorian Calendar.</p>
        <button popovertargetaction="hide" popovertarget="second-earth-time">close</button>
    </div>
    <div popover id="third-earth-time">
        <p>Roughly 2,600 <abbr title="Common Era">CE</abbr> to 3,200 <abbr title="Common Era">CE</abbr> in the Gegorian Calendar.</p>
